...
def run_extractive(input_path, output_path):
...
run_extractive('../datasets/reviews.csv', '../outputs/extractive.reviews.summaries.csv')

run_extractive('../datasets/news.csv', '../outputs/extractive.news.summaries.csv')